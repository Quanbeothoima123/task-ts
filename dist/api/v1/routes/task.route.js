...
const task_validate_1 = require("../../../validates/user/task.validate");
...
router.post("/create", task_validate_1.validateCreateTask, taskController.create);
router.patch("/edit/:id", task_validate_1.validateEditTask, taskController.edit);
